...
class ExpNimManager():
    ...
    def move(self, player_number, num_stones, reset=False):
        ...
        game_state['init_max'] = self.__init_max
        #game_state['player_0_reset_left'] = self.players[0].resets_left
    ...
    def run_game(self):
        ...
        self.__server.update_all_clients(bytes(json.dumps({'init_stones': self.stones_left, 'init_resets': self.init_resets}), 'utf-8'))
        #self.__server.update_all_clients(bytes(json.dumps({'init_stones': self.stones_left,'init_resets': self.init_resets})))
        ...
        while True:
            ...
            #game_state_bytes = bytes(json.dumps(game_state))
